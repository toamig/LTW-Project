...
<?php function messageLeftPanel($messages) { ?>
    ...
    <div class="message-left-panel">
        <div class="self-id">
            ...
            <button class="create-new-message-btn" onclick="createNewMessage()">
